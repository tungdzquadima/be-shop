    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/orders/**").hasAnyRole(Role.USER, Role.ADMIN)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/products/search**").hasAnyRole(Role.USER, Role.ADMIN)
